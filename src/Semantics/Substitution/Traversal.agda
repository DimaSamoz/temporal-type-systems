...
module _ {𝒮} {k : Kit 𝒮} (⟦k⟧ : ⟦Kit⟧ k) where
    ...
    traverse′-sound {Γ} {Δ} σ (letEvt_In_ {A = A} {B} E C) {n} {⟦Δ⟧}
        ...
        begin
            μ.at ⟦ B ⟧ₜ n
                (F-◇.fmap (⟦ C ⟧ᵐ ∘ ⟦subst⟧ (_↑_ {A = A now} (σ ↓ˢ k) k) ∘ ε.at ⟦ Δ ˢ ⟧ₓ * id) n
                         (st ⟦ Δ ˢ ⟧ₓ ⟦ A ⟧ₜ n (⟦ Δ ˢ⟧□ n ⟦Δ⟧ , ⟦ E ⟧ₘ n (⟦subst⟧ σ n ⟦Δ⟧))))
        ≡⟨ cong (μ.at ⟦ B ⟧ₜ n) (F-◇.fmap-∘ {g = ⟦ C ⟧ᵐ} {⟦subst⟧ (_↑_ {A = A now} (σ ↓ˢ k) k) ∘ ε.at ⟦ Δ ˢ ⟧ₓ * id}
                                         {n} {st ⟦ Δ ˢ ⟧ₓ ⟦ A ⟧ₜ n (⟦ Δ ˢ⟧□ n ⟦Δ⟧ , ⟦ E ⟧ₘ n (⟦subst⟧ σ n ⟦Δ⟧))}) ⟩
            μ.at ⟦ B ⟧ₜ n (F-◇.fmap (⟦ C ⟧ᵐ) n
                (F-◇.fmap (⟦subst⟧ (_↑_ {A = A now} (σ ↓ˢ k) k) ∘ ε.at ⟦ Δ ˢ ⟧ₓ * id) n
                     (st ⟦ Δ ˢ ⟧ₓ ⟦ A ⟧ₜ n (⟦ Δ ˢ⟧□ n ⟦Δ⟧ , ⟦ E ⟧ₘ n (⟦subst⟧ σ n ⟦Δ⟧)))))
        ≡⟨ cong (λ x → μ.at ⟦ B ⟧ₜ n (F-◇.fmap ⟦ C ⟧ᵐ n x)) (
            ...
            μ.at ⟦ B ⟧ₜ n (F-◇.fmap ⟦ C ⟧ᵐ n
                ...
                (st ⟦ Γ ˢ ⟧ₓ ⟦ A ⟧ₜ n ( ⟦ Γ ˢ⟧□ n (⟦subst⟧ σ n ⟦Δ⟧)
                                   , ⟦ E ⟧ₘ n (⟦subst⟧ σ n ⟦Δ⟧)))))
        ≡⟨ cong (μ.at ⟦ B ⟧ₜ n) (sym (F-◇.fmap-∘ {g = ⟦ C ⟧ᵐ}{ε.at ⟦ Γ ˢ ⟧ₓ * id}{n}
                            {st ⟦ Γ ˢ ⟧ₓ ⟦ A ⟧ₜ n ( ⟦ Γ ˢ⟧□ n (⟦subst⟧ σ n ⟦Δ⟧)
                                               , ⟦ E ⟧ₘ n (⟦subst⟧ σ n ⟦Δ⟧))})) ⟩
            μ.at ⟦ B ⟧ₜ n (F-◇.fmap (⟦ C ⟧ᵐ ∘ ε.at ⟦ Γ ˢ ⟧ₓ * id) n
                (st ⟦ Γ ˢ ⟧ₓ ⟦ A ⟧ₜ n ( ⟦ Γ ˢ⟧□ n (⟦subst⟧ σ n ⟦Δ⟧)
                                   , ⟦ E ⟧ₘ n (⟦subst⟧ σ n ⟦Δ⟧))))
        ≡⟨⟩
    ...
    traverse′-sound {_} {Δ} σ (select_↦_||_↦_||both↦_ {Γ} {A} {B} {C} E₁ C₁ E₂ C₂ C₃) {n} {⟦Δ⟧}
        ...
        begin
            μ.at ⟦ C ⟧ₜ n
                (F-◇.fmap (⌞ handle ⟦ traverse′ (σ ↓ˢ k ↑ k ↑ k) C₁ ⟧ᵐ
                                    ...
                                    ⟦ traverse′ (σ ↓ˢ k ↑ k ↑ k) C₃ ⟧ᵐ ⌟ ∘ ε.at ⟦ Δ ˢ ⟧ₓ * id) n
                (st ⟦ Δ ˢ ⟧ₓ (⟦ A ⟧ₜ ⊛ ⟦ B ⟧ₜ) n
        ...
        ≡⟨ cong! (ext λ m → ext λ b → ind-hyp m b) ⟩
            μ.at ⟦ C ⟧ₜ n
                (F-◇.fmap (⌞ handle
                       ...
                       (⟦ C₃ ⟧ᵐ ∘ (⟦subst⟧ (_↑_ {B now} (_↑_ {A now}       (σ ↓ˢ k) k) k))) ⌟
                       ∘ ε.at ⟦ Δ ˢ ⟧ₓ * id) n
                (st ⟦ Δ ˢ ⟧ₓ (⟦ A ⟧ₜ ⊛ ⟦ B ⟧ₜ) n
                (⟦ Δ ˢ⟧□ n ⟦Δ⟧ , ⟪ ⟦ E₁ ⟧ₘ ∘ ⟦subst⟧ σ , ⟦ E₂ ⟧ₘ ∘ ⟦subst⟧ σ ⟫ n ⟦Δ⟧)))
        ≡⟨ cong! (ext λ m → ext λ b →
            ...
            μ.at ⟦ C ⟧ₜ n
                (F-◇.fmap (handle ⟦ C₁ ⟧ᵐ ⟦ C₂ ⟧ᵐ ⟦ C₃ ⟧ᵐ ∘ ⟦subst⟧ (σ ↓ˢ k) * id ∘ ε.at ⟦ Δ ˢ ⟧ₓ * id) n
                (st ⟦ Δ ˢ ⟧ₓ (⟦ A ⟧ₜ ⊛ ⟦ B ⟧ₜ) n
                (⟦ Δ ˢ⟧□ n ⟦Δ⟧ , ⟪ ⟦ E₁ ⟧ₘ ∘ ⟦subst⟧ σ , ⟦ E₂ ⟧ₘ ∘ ⟦subst⟧ σ ⟫ n ⟦Δ⟧)))
        ≡⟨ cong (μ.at ⟦ C ⟧ₜ n) (F-◇.fmap-∘ {g = handle ⟦ C₁ ⟧ᵐ ⟦ C₂ ⟧ᵐ ⟦ C₃ ⟧ᵐ}
                      {f = ⟦subst⟧ (σ ↓ˢ k) * id ∘ ε.at ⟦ Δ ˢ ⟧ₓ * id} {n}
                      {st ⟦ Δ ˢ ⟧ₓ (⟦ A ⟧ₜ ⊛ ⟦ B ⟧ₜ) n
                      (⟦ Δ ˢ⟧□ n ⟦Δ⟧ , ⟪ ⟦ E₁ ⟧ₘ ∘ ⟦subst⟧ σ , ⟦ E₂ ⟧ₘ ∘ ⟦subst⟧ σ ⟫ n ⟦Δ⟧)})
         ⟩
        ...
        ≡⟨ cong (λ x → μ.at ⟦ C ⟧ₜ n (F-◇.fmap (handle ⟦ C₁ ⟧ᵐ ⟦ C₂ ⟧ᵐ ⟦ C₃ ⟧ᵐ) n x)) (
            ...
            μ.at ⟦ C ⟧ₜ n (F-◇.fmap (handle ⟦ C₁ ⟧ᵐ ⟦ C₂ ⟧ᵐ ⟦ C₃ ⟧ᵐ) n
                ...
                (st ⟦ Γ ˢ ⟧ₓ (⟦ A ⟧ₜ ⊛ ⟦ B ⟧ₜ) n
                (⟦ Γ ˢ⟧□  n (⟦subst⟧ σ n ⟦Δ⟧) , ⟪ ⟦ E₁ ⟧ₘ , ⟦ E₂ ⟧ₘ ⟫  n (⟦subst⟧ σ n ⟦Δ⟧)))))
        ≡⟨ cong (μ.at ⟦ C ⟧ₜ n) (sym (F-◇.fmap-∘ {g = handle ⟦ C₁ ⟧ᵐ ⟦ C₂ ⟧ᵐ ⟦ C₃ ⟧ᵐ}
            {ε.at ⟦ Γ ˢ ⟧ₓ * id}{n} {st ⟦ Γ ˢ ⟧ₓ (⟦ A ⟧ₜ ⊛ ⟦ B ⟧ₜ) n
                (⟦ Γ ˢ⟧□  n (⟦subst⟧ σ n ⟦Δ⟧) , ⟪ ⟦ E₁ ⟧ₘ , ⟦ E₂ ⟧ₘ ⟫  n (⟦subst⟧ σ n ⟦Δ⟧))})) ⟩
            μ.at ⟦ C ⟧ₜ n (F-◇.fmap (handle ⟦ C₁ ⟧ᵐ ⟦ C₂ ⟧ᵐ ⟦ C₃ ⟧ᵐ ∘ ε.at ⟦ Γ ˢ ⟧ₓ * id) n
                (st ⟦ Γ ˢ ⟧ₓ (⟦ A ⟧ₜ ⊛ ⟦ B ⟧ₜ) n
                (⟦ Γ ˢ⟧□  n (⟦subst⟧ σ n ⟦Δ⟧) , ⟪ ⟦ E₁ ⟧ₘ , ⟦ E₂ ⟧ₘ ⟫  n (⟦subst⟧ σ n ⟦Δ⟧))))
        ≡⟨⟩
